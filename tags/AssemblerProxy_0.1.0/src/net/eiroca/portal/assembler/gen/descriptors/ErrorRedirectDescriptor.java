 ...
 */
public class ErrorRedirectDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
  ...
  public ErrorRedirectDescriptor() {
    super();
    _xmlName = "ErrorRedirect";
