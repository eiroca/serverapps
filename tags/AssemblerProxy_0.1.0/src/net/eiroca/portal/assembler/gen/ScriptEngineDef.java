...
/**
 * Class ScriptEngineDef.
 *
 * @version $Revision$ $Date$
 */
public class ScriptEngineDef extends DelegateDefType implements java.io.Serializable {

  //----------------/
  //- Constructors -/
  //----------------/

  public ScriptEngineDef() {
    super();
  }
  ...
  public static net.eiroca.portal.assembler.gen.DelegateDefType unmarshal(
    ...
    return (net.eiroca.portal.assembler.gen.DelegateDefType)Unmarshaller.unmarshal(net.eiroca.portal.assembler.gen.ScriptEngineDef.class, reader);
  }
