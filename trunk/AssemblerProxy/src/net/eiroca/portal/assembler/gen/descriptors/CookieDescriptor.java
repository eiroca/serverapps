 ...
 */
public class CookieDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
  ...
  public CookieDescriptor() {
    ...
    handler = new org.exolab.castor.xml.handlers.EnumFieldHandler(net.eiroca.portal.assembler.gen.types.CookieAccessType.class, handler);
    desc.setImmutable(true);
    desc.setSchemaType("CookieAccessType");
