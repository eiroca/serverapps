 ...
 */
public class ScriptConfig extends ScriptConfigType implements java.io.Serializable {
  ...
  public static net.eiroca.portal.assembler.gen.ScriptConfigType unmarshal(
    ...
    return (net.eiroca.portal.assembler.gen.ScriptConfigType)Unmarshaller.unmarshal(net.eiroca.portal.assembler.gen.ScriptConfig.class, reader);
  }
