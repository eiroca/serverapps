 ...
 */
public class Copy extends ResourceType implements java.io.Serializable {
  ...
  public static net.eiroca.portal.assembler.gen.ResourceType unmarshal(
    ...
    return (net.eiroca.portal.assembler.gen.ResourceType)Unmarshaller.unmarshal(net.eiroca.portal.assembler.gen.Copy.class, reader);
  }
