 ...
 */
public class ScriptPostProcessor extends DelegateCallType implements java.io.Serializable {

  //----------------/
  //- Constructors -/
  //----------------/

  public ScriptPostProcessor() {
    super();
  }
  ...
  public static net.eiroca.portal.assembler.gen.DelegateCallType unmarshal(
    ...
    return (net.eiroca.portal.assembler.gen.DelegateCallType)Unmarshaller.unmarshal(net.eiroca.portal.assembler.gen.ScriptPostProcessor.class, reader);
  }
