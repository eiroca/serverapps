...
public class AdminConfig implements java.io.Serializable {
   ...
   * Field _adminContext.
   */
  private java.lang.String _adminContext;
  ...
  /**
   * Returns the value of field 'adminContext'.
   *
   * @return the value of field 'AdminContext'.
   */
  ...
  /**
   * Sets the value of field 'adminContext'.
   *
   * @param adminContext the value of field 'adminContext'.
   */
   ...
   * net.eiroca.portal.assembler.gen.AdminConfig
   */
  public static net.eiroca.portal.assembler.gen.AdminConfig unmarshal(
      final java.io.Reader reader) throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
    return (net.eiroca.portal.assembler.gen.AdminConfig)Unmarshaller.unmarshal(net.eiroca.portal.assembler.gen.AdminConfig.class, reader);
  }
