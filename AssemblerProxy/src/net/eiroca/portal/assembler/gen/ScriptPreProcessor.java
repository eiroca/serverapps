 ...
 */
public class ScriptPreProcessor extends DelegateCallType implements java.io.Serializable {
  ...
  public static net.eiroca.portal.assembler.gen.DelegateCallType unmarshal(
    ...
    return (net.eiroca.portal.assembler.gen.DelegateCallType)Unmarshaller.unmarshal(net.eiroca.portal.assembler.gen.ScriptPreProcessor.class, reader);
  }
