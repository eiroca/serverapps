 ...
 */
public class ExtractorConfigDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
  ...
  public ExtractorConfigDescriptor() {
    super();
    _xmlName = "ExtractorConfig";
    ...
    desc.setComponentType("net.eiroca.portal.assembler.gen.ExtractorDef");
    ...
    //-- validation code for: _extractorDefList
