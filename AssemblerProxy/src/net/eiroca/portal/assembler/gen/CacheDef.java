 ...
 */
public class CacheDef extends DelegateDefType implements java.io.Serializable {
  ...
  public static net.eiroca.portal.assembler.gen.DelegateDefType unmarshal(
    ...
    return (net.eiroca.portal.assembler.gen.DelegateDefType)Unmarshaller.unmarshal(net.eiroca.portal.assembler.gen.CacheDef.class, reader);
  }
